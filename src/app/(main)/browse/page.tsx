...
export default function Browse() {
  ...
  const fetchListings = useCallback(async (reset = true) => {
    ...
    if (reset) { setIsLoading(true); setFetchError(false); }
            ...
            {isLoading ? (
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                {Array.from({ length: 6 }).map((_, i) => (
                  <div key={i} className="bg-white rounded-3xl overflow-hidden shadow-sm border border-purple-50 animate-pulse">
                    <div className="w-full h-56 bg-purple-100" />
              ...
              <div className="flex flex-col items-center justify-center py-20 text-center glass rounded-3xl">
                ...
                <h3 className="font-serif text-2xl font-bold mb-2 text-purple-900">Failed to load</h3>
                <p className="text-purple-600/80 mb-6">Could not reach the server. Check your connection.</p>
                <Button
